    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.csrf(AbstractHttpConfigurer::disable)
            ...
            .authorizeHttpRequests(req -> req
                ...
                .requestMatchers(HttpMethod.POST, "/materials/**")
                .hasAnyRole(String.valueOf(ERole.ADMIN), String.valueOf(ERole.SUPER_ADMIN))
                .requestMatchers(HttpMethod.PUT, "/materials/**")
                .hasAnyRole(String.valueOf(ERole.ADMIN), String.valueOf(ERole.SUPER_ADMIN))
                .requestMatchers(HttpMethod.DELETE, "/materials/**")
                .hasAnyRole(String.valueOf(ERole.ADMIN), String.valueOf(ERole.SUPER_ADMIN))
                ...
                .hasAnyRole(String.valueOf(ERole.SUPER_ADMIN), String.valueOf(ERole.ADMIN))
